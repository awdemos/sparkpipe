...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_QUERY 0x00000400u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_KEY 0x00000800u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_WEIGHTS 0x00001000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_INDEXER \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_QUERY | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_KEY | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_LINEAR_PLAN_BIND_DSA_WEIGHTS)
...
typedef struct SparkGlm52ResidentDecodeStageLinearPlanResidentBindingCreateInfo
{
    ...
    const void *raw_query_a_weight_fp8_e4m3;
    const void *raw_query_a_weight_scale_inv_f32;
    void *raw_query_a_output_bf16;
    const void *raw_query_b_input_bf16;
    const void *raw_query_b_weight_bf16;
    const void *raw_query_b_weight_fp8_e4m3;
    const void *raw_query_b_weight_scale_inv_f32;
    void *raw_query_b_output_bf16;
    const void *raw_kv_a_weight_bf16;
    const void *raw_kv_a_weight_fp8_e4m3;
    const void *raw_kv_a_weight_scale_inv_f32;
    void *raw_kv_a_output_bf16;
    const void *raw_kv_b_input_bf16;
    const void *raw_kv_b_weight_bf16;
    const void *raw_kv_b_weight_fp8_e4m3;
    const void *raw_kv_b_weight_scale_inv_f32;
    void *raw_kv_b_output_bf16;
    const void *attention_output_input_bf16;
    const void *attention_output_weight_bf16;
    const void *attention_output_weight_fp8_e4m3;
    const void *attention_output_weight_scale_inv_f32;
    ...
    const void *dsa_query_input_bf16;
    const void *dsa_query_weight_bf16;
    const void *dsa_query_weight_fp8_e4m3;
    const void *dsa_query_weight_scale_inv_f32;
    void *dsa_query_output_bf16;
    const void *dsa_key_input_bf16;
    const void *dsa_key_weight_bf16;
    const void *dsa_key_weight_fp8_e4m3;
    const void *dsa_key_weight_scale_inv_f32;
    void *dsa_key_output_bf16;
    const void *dsa_weights_input_bf16;
    const void *dsa_weights_proj_weight_bf16;

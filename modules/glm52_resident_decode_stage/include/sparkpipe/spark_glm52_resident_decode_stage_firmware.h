...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MOE_W1_COMPONENT_COUNT \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_STREAM_ORDERED 0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_DEVICE_POINTERS 0x00000002u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_DYNAMIC_SCALES 0x00000004u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_COMPRESSED_MLA_ONLY 0x00000008u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_STREAM_ORDERED | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_DEVICE_POINTERS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_KV_CACHE_CAPABILITY_DYNAMIC_SCALES)
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_QUERY_ROPE_PROJECTION_DIMENSION \
    SPARK_GLM52_MODEL_QUERY_ROPE_PROJECTION_DIMENSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_SCALE_EXTENT(dimension) \
    SPARK_GLM52_MODEL_FP8_SCALE_EXTENT(dimension)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_SCALE_COUNT(rows, columns) \
    SPARK_GLM52_MODEL_FP8_SCALE_COUNT(rows, columns)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_FP8_LINEAR_SCALE_COUNT \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_SELECTED_BLOCK_COUNT \
    ((SPARK_GLM52_RESIDENT_DECODE_STAGE_SELECTED_TOKEN_COUNT + \
      SPARK_GLM52_RESIDENT_DECODE_STAGE_BLOCK_TOKENS - 1u) / \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_QUERY_DIMENSION \
    SPARK_GLM52_MODEL_DSA_INDEX_QUERY_DIMENSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_KEY_DIMENSION \
    SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_HEAD_DIMENSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_WEIGHT_DIMENSION \
    SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_HEAD_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_INDEX_ROPE_DIMENSION \
    SPARK_GLM52_RESIDENT_DECODE_STAGE_ROPE_DIMENSION
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_RESTRICTED_VOCAB_COUNT \
    SPARK_GLM52_MODEL_RESTRICTED_VOCAB_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_OUTPUT_VOCAB_COUNT \
    SPARK_GLM52_MODEL_OUTPUT_VOCAB_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_HIDDEN_BF16_BYTES \
    SPARK_GLM52_MODEL_HIDDEN_BF16_BYTES
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_SELECTED_INDEX_BYTES \
    SPARK_GLM52_MODEL_DSA_SELECTED_INDEX_BYTES
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MTP_DRAFT_TOKEN_COUNT \
    SPARK_GLM52_MODEL_MTP_DRAFT_TOKEN_COUNT
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_SPECULATIVE_ROWS_PER_LANE \
    SPARK_GLM52_MODEL_MAX_SPECULATIVE_ROWS_PER_LANE
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MXFP4_GROUP_SIZE \
    SPARK_GLM52_MODEL_MXFP4_GROUP_SIZE
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_NVFP4_GROUP_SIZE \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MTP_DRAFT_PLAN_ABI_VERSION 2u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FINAL_EPILOGUE_CANDIDATE_GROUP_COUNT \
    ((SPARK_GLM52_RESIDENT_DECODE_STAGE_OUTPUT_VOCAB_COUNT + \
     ...
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FINAL_EPILOGUE_CANDIDATE_GROUP_SIZE)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_PIPELINE_SLOT_COUNT \
    SPARK_STAGE_PLAN_MAX_BATCH_BUCKET
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_EXECUTION_ROW_COUNT \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FIRST_ROUTED_LAYER \
    SPARK_GLM52_MODEL_FIRST_ROUTED_LAYER
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_ROUTED_STAGE_SLICE_LAYER_COUNT \
    SPARK_STAGE_PLAN_MAX_ROUTED_LAYERS_PER_STAGE
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_STAGE_SLICE_LAYER_COUNT \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_FIRST_ROUTED_LAYER + \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_MAX_ROUTED_STAGE_SLICE_LAYER_COUNT)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_PAGED_PREFILL_QUERY_TILE_TOKENS 16u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_PAGED_PREFILL_KEY_TILE_TOKENS 16u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_MTP_GRAPH_VARIANT_COUNT \
    ((SPARK_GLM52_RESIDENT_DECODE_STAGE_MTP_DRAFT_TOKEN_COUNT * 2u) + 1u)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_CUDA_GRAPH_SPARE_ENTRY_COUNT \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_MTP_GRAPH_VARIANT_COUNT - 1u)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_CUDA_SLOT_STATE_ABI_VERSION 3u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_SLICE_NODE_CONTEXT_ABI_VERSION 3u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_OUTPUT_HIDDEN_ONLY 0x00004000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_REQUIRE_BULK_PREFILL 0x00008000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_REQUIRE_STAGE_SLICE_PLAN 0x00010000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_REQUIRE_MODEL_QUANTIZATION 0x00020000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_REQUIRE_RUNTIME_KV_BLOCK_TABLE 0x00040000u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXECUTION_REQUIRE_DSA_KV_FRAGMENT_TRANSPORT 0x00400000u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FULL_STAGE_CAPABILITY_FUSED_MOE 0x00000020u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FULL_STAGE_SOTA_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_FULL_STAGE_CAPABILITY_STREAM_ORDERED | \
     ...
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FULL_STAGE_CAPABILITY_FUSED_MOE | \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_STREAM_ORDERED 0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_CUDA_GRAPH_REPLAY 0x00000002u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_TENSOR_CORE_PROJECTIONS 0x00000004u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_TILED_ONLINE_ATTENTION 0x00000008u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FUSED_LAYER_PROGRESS 0x00000010u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FAST_RESTRICTED_LOGITS 0x00000020u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FAST_MTP_DRAFT 0x00000040u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_ZERO_HOST_STAGING 0x00000080u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_ZERO_DEVICE_MEMCPY 0x00000100u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_DEVICE_HIDDEN_HANDOFF 0x00000200u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_QKV_BRANCH_OVERLAP 0x00000400u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_EXACT_RING_FIXED6 0x00000800u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_VLLM_PAGED_PREFILL 0x00001000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_INTERNAL_CUDA_GRAPH_COUNTERS 0x00002000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_AOT_STAGE_LAUNCH 0x00004000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FUSED_STAGE_MOE 0x00008000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FUSED_FINAL_TOKEN_TAIL 0x00010000u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_BUILTIN_EXACT_RING_AOT 0x00020000u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_STREAM_ORDERED | \
     ...
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_TENSOR_CORE_PROJECTIONS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_TILED_ONLINE_ATTENTION | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_FUSED_LAYER_PROGRESS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_ZERO_HOST_STAGING | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_ZERO_DEVICE_MEMCPY)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_EXACT_RING_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_REQUIRED_CAPABILITIES | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_DEVICE_HIDDEN_HANDOFF | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_EXACT_RING_FIXED6 | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_INTERNAL_CUDA_GRAPH_COUNTERS)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_PRODUCTION_RING_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_EXACT_RING_CAPABILITIES | \
     ...
     SPARK_GLM52_RESIDENT_DECODE_STAGE_STAGE_SLICE_CAPABILITY_BUILTIN_FUSED_STAGE_MOE | \
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_STREAM_ORDERED 0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_TENSOR_CORE_PROJECTIONS 0x00000002u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_BLOCK_KV_WRITE 0x00000004u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_TILED_ATTENTION 0x00000008u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_ZERO_HOST_STAGING 0x00000010u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_ZERO_DEVICE_MEMCPY 0x00000020u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_PAGED_BLOCK_TABLE 0x00000040u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_CHUNKED_PROMPT 0x00000080u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_PREFIX_CACHE 0x00000100u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_STREAM_ORDERED | \
     ...
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_BLOCK_KV_WRITE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_TILED_ATTENTION | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_ZERO_HOST_STAGING | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_ZERO_DEVICE_MEMCPY)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_PAGED_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_REQUIRED_CAPABILITIES | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_PAGED_BLOCK_TABLE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_CHUNKED_PROMPT)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_PAGED_ATTENTION_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_PAGED_REQUIRED_CAPABILITIES | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_PREFIX_CACHE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_PAGED_ATTENTION | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_RUNTIME_KV_TABLE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_BULK_PREFILL_CAPABILITY_VARIABLE_PROMPT_LENGTHS)

#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_DISPATCH_PLAN_KIND_FLASHINFER_B12X 1u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_PLAN_ABI_VERSION 1u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_STREAM_ORDERED 0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_FUSED_EXPERTS 0x00000002u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_FUSED_TOPK_REDUCE 0x00000004u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_IN_KERNEL_INPUT_QUANT 0x00000008u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_ZERO_HOST_STAGING 0x00000010u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_ZERO_DEVICE_MEMCPY 0x00000020u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_STREAM_ORDERED | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_FUSED_EXPERTS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_FUSED_TOPK_REDUCE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_IN_KERNEL_INPUT_QUANT | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_ZERO_HOST_STAGING | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_B12X_MOE_CAPABILITY_ZERO_DEVICE_MEMCPY)

#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_STREAM_ORDERED 0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_FUSED_EXPERTS 0x00000002u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_FUSED_TOPK_REDUCE 0x00000004u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_TENSOR_CORE 0x00000008u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_ZERO_HOST_STAGING 0x00000010u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_ZERO_DEVICE_MEMCPY 0x00000020u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_STREAM_ORDERED | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_FUSED_EXPERTS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_FUSED_TOPK_REDUCE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_TENSOR_CORE | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_ZERO_HOST_STAGING | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_CAPABILITY_ZERO_DEVICE_MEMCPY)
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_GATE_UP_ORDER_UP_GATE 1u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_WEIGHT_LAYOUT_EXPERT_MAJOR_ROW_MAJOR 1u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_SCALE_LAYOUT_EXPERT_MAJOR_ROW_BLOCK_MAJOR 1u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_QUANT_MODE_E4M3 2u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_SCALE_BLOCK_SIZE \
    SPARK_GLM52_MODEL_FP8_SCALE_BLOCK
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FP8_MOE_WEIGHT_ALIGNMENT_BYTES 16u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_ABI_VERSION 8u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_KV_BLOCK_TABLE \
    0x00000001u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_HIDDEN_INPUT_TRANSPORT \
    0x00000002u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_PREFILL_VIEW \
    0x00000010u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_MTP_DRAFT_BUDGETS \
    0x00000020u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_LAYER_MAJOR_SPECULATIVE_VERIFY \
    0x00000080u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_MTP_TREE_VERIFY \
    0x00000100u
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_FRAME_CONTEXT_FLAG_HIDDEN_INPUT_PRERECEIVED \
    0x00000200u
...
typedef SparkStatus (*SparkGlm52ResidentDecodeStageHiddenTransportSendSessionFunction)(
    SparkHiddenTransportSession *transport_session,
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_PAYLOAD_FLAG_L2_PREFETCH_ONLY 0x00000040u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_READ_ONLY_PREFETCH 0x00000020u
...
#define SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_READ_ONLY_REQUIRED_CAPABILITIES \
    (SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_STREAM_ORDERED | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_DEVICE_POINTERS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_SELECTED_BLOCKS | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_ASYNC_EVENT_READY | \
     SPARK_GLM52_RESIDENT_DECODE_STAGE_DSA_KV_FRAGMENT_TRANSPORT_CAPABILITY_READ_ONLY_PREFETCH)
...
typedef enum SparkGlm52ResidentDecodeStageModelQuantizationMode
{
...
typedef struct SparkGlm52ResidentDecodeStageFp8KvCachePlan
{
    ...
    uint64_t workspace_bytes;
    uint64_t validated_maximum_latency_ns;
} SparkGlm52ResidentDecodeStageFp8KvCachePlan;
...
typedef struct SparkGlm52ResidentDecodeStageStageSlicePlan
{
    uint32_t abi_version;
    uint32_t maximum_active_sequence_count;
    ...
    uint64_t workspace_bytes;
    uint64_t validated_maximum_latency_ns;
} SparkGlm52ResidentDecodeStageStageSlicePlan;




typedef struct SparkGlm52ResidentDecodeStageExactStageSlicePlan
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    ...
    uint64_t workspace_bytes;
    uint64_t validated_maximum_latency_ns;
} SparkGlm52ResidentDecodeStageExactStageSlicePlan;

#define SPARK_GLM52_RESIDENT_DECODE_STAGE_EXACT_STAGE_SLICE_PLAN_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkGlm52ResidentDecodeStageExactStageSlicePlan))

typedef struct SparkGlm52ResidentDecodeStagePagedPrefillPlan
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    ...
    uint64_t workspace_bytes;
    uint64_t validated_maximum_latency_ns;
} SparkGlm52ResidentDecodeStagePagedPrefillPlan;

#define SPARK_GLM52_RESIDENT_DECODE_STAGE_PAGED_PREFILL_PLAN_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkGlm52ResidentDecodeStagePagedPrefillPlan))

typedef struct SparkGlm52ResidentDecodeStageBulkPrefillPlan
{
    uint32_t abi_version;
    uint32_t maximum_active_sequence_count;
    uint32_t maximum_prompt_token_count;
...
typedef struct SparkGlm52ResidentDecodeStageSliceNodeContext
{
    uint32_t abi_version;
    uint32_t descriptor_bytes;
    uint32_t first_layer_index;
...
} SparkGlm52ResidentDecodeStageSliceNodeContext;

#define SPARK_GLM52_RESIDENT_DECODE_STAGE_SLICE_NODE_CONTEXT_DESCRIPTOR_BYTES \
    ((uint32_t)sizeof(SparkGlm52ResidentDecodeStageSliceNodeContext))
...
SparkStatus SparkGlm52ResidentDecodeStageLaunchFlashInferB12xMoe(
    const SparkGlm52ResidentDecodeStageB12xMoeDispatchPlan *b12x_moe_dispatch_plan,

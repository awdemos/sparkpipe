...
#define SPARK_DSV4_STAGEPACK_WEIGHT_FP8_E4M3 3u
#define SPARK_DSV4_STAGEPACK_WEIGHT_FP4_E2M1 4u
...
static inline int32_t SparkDsv4StagePackShapeOfLayer(uint32_t tensor_kind, SparkDsv4StagePackTensorShape *shape)
{
	...
	case SPARK_DSV4_STAGEPACK_TENSOR_WO_A: shape->rows = SPARK_DSV4_MODEL_OUTPUT_GROUP_COUNT * SPARK_DSV4_MODEL_OUTPUT_LORA_RANK; shape->columns = SPARK_DSV4_MODEL_OUTPUT_GROUP_DIMENSION; return(0);

...
EXEMPT = {
    ...
    "GLM52_VOCAB": "the sampling head is not written",
    ...
    "MIMO25_VOCAB": "the sampling head is not written",
    "MIMO25_RMS_EPSILON": "passed by the host, not named in unity.cu",
    "QWEN36_VOCAB": "the sampling head is not written",
    "QWEN36_MTP_LAYERS": "speculation not driven yet",
    "K3_VOCAB": "the sampling head is not written",
    "DSV4_VOCAB": "the sampling head is not written",

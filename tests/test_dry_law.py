...
GLM_BUDGET = {
    ...
    "include/sparkpipe/spark_resident_decode_stage.h": (27, "weight/plan config-flow pending (A4)"),
    ...
    "inference/stage/module.c": (33, "drafter wiring (glm data); stage firmware (A4)"),

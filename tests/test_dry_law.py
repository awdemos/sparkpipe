...
GLM_BUDGET = {
    ...
    "include/sparkpipe/spark_resident_decode_stage.h": (145, "weight/plan config-flow pending (A4)"),
    ...
    "include/sparkpipe/spark_request_api.h": (10, "drafter wiring (glm data); kv-cache seam (A3)"),
    ...
    "scheduler/work_control.c": (135, "seam includes"),
    ...
    "runtime/pack/artifact_check.c": (73, "stage firmware (A4)"),
    "runtime/pack/fp8_resident_pack.py": (5, "stage firmware (A4)"),
    "runtime/pack/stage_pack.py": (2, "seam includes"),
    "runtime/pack/stagepack.c": (58, "stagepack format (pack decision)"),
    ...
    "inference/stage/module.c": (84, "drafter wiring (glm data); stage firmware (A4)"),

...
GLM_BUDGET = {
    ...
    "node/backend.c": (50, "drafter wiring (glm data); kv-cache seam (A3); stage firmware (A4)"),
    ...
    "inference/stage/dispatch.cu": (55, "stage firmware (A4)"),
    "inference/stage/draft_backend.cu": (600, "drafter wiring (glm data)"),
    "inference/stage/legacy_entry.cu": (6, "stage firmware (A4)"),
    "inference/stage/module.c": (1034, "drafter wiring (glm data); stage firmware (A4)"),
    "inference/stage/runner.c": (80, "stage firmware (A4)"),
    "inference/stage/serving_adapter.cu": (163, "stage firmware (A4)"),
}

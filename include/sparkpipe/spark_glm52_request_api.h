...
#define SPARK_GLM52_REQUEST_API_MTP_SCHEDULED_DRAFT_TOKEN_COUNT 3u

#if SPARK_GLM52_REQUEST_API_MTP_SCHEDULED_DRAFT_TOKEN_COUNT > \
    SPARK_GLM52_REQUEST_API_MTP_MAX_DRAFT_TOKEN_COUNT
#error "scheduled MTP draft count exceeds model capacity"
#endif
